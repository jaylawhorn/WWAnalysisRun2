...
void setOutputTree::initializeVariables()
{
  ...
  VBSCentrality=-999;
  TempLepWEta = -999;
  TempLepWRapidity = -999;
  TempHadWEta = -999;
  TempHadWRapidity = -999;
  TempWWEta = -999;
  TempWWRapidity = -999;
//  AK4_1_pt_gen=-999;
//  AK4_1_eta_gen=-999;
...
void setOutputTree::setBranches()
{
  ...
  fTree->Branch("TempLepWEta", &TempLepWEta , "TempLepWEta/F");
  fTree->Branch("TempLepWRapidity", &TempLepWRapidity , "TempLepWRapidity/F");
  fTree->Branch("TempHadWEta", &TempHadWEta , "TempHadWEta/F");
  fTree->Branch("TempHadWRapidity", &TempHadWRapidity , "TempHadWRapidity/F");
  fTree->Branch("TempWWEta", &TempWWEta , "TempWWEta/F");
  fTree->Branch("TempWWRapidity", &TempWWRapidity , "TempWWRapidity/F");
