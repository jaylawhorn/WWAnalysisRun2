...
class setOutputTree {
 ...
 public:
  ...
  int isResolved; //0=boosted, 1=resolved
  int lepType; //0=muon, 1=electron
  int isWnotZ; //0=Z, 1=W
  ...
  float pfMET_Corr_jer_up; 
  float pfMET_Corr_jer_dn; 
  ...
  float mass_lvj_type0_PuppiAK8_lep_up;//?
  float mass_lvj_type0_PuppiAK8_lep_dn;//?

  float mass_llj_PuppiAK8;
  float mass_llj_PuppiAK8_jes_up;
  float mass_llj_PuppiAK8_jes_dn;
  float mass_llj_PuppiAK8_jer_up;
  float mass_llj_PuppiAK8_jer_dn;
  float mass_llj_PuppiAK8_lep_up;
  float mass_llj_PuppiAK8_lep_dn;

  float mass_lvjj_type0_AK4AK4;
  float mass_lvjj_type0_AK4AK4_jes_up;
  float mass_lvjj_type0_AK4AK4_jes_dn;
  float mass_lvjj_type0_AK4AK4_jer_up;
  float mass_lvjj_type0_AK4AK4_jer_dn;
  float mass_lvjj_type0_AK4AK4_lep_up;//?
  float mass_lvjj_type0_AK4AK4_lep_dn;//?

  float mass_lljj_AK4AK4;
  float mass_lljj_AK4AK4_jes_up;
  float mass_lljj_AK4AK4_jes_dn;
  float mass_lljj_AK4AK4_jer_up;
  float mass_lljj_AK4AK4_jer_dn;
  float mass_lljj_AK4AK4_lep_up;
  float mass_lljj_AK4AK4_lep_dn;
  ...
  float ZeppenfeldWL_type0_lep_up;//?
  float ZeppenfeldWL_type0_lep_dn;//?
  ...
  float BosonCentrality_type0_lep_up;//?
  float BosonCentrality_type0_lep_dn;//?
